...
<li class="nav-item">
    ...
    <div id="collapsesuper" class="collapse" aria-labelledby="headingpermissions"
        data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="{{route('superskills.index')}}"><i class="fa-solid fa-list"></i> {{__('admin.All Super Skills')}}</a>
            <a class="collapse-item" href="{{ route('superskills.create') }}"><i class="ion-plus-circled"></i> {{__('admin.Add Super Skill')}}</a>
